  ...
  <main className="main">
      ...
      <div className="main-header__intro-wrapper">
        <div className="main-header__welcome">
          <div className="main-header__welcome-title text-light">
            Bienvenido, <strong>Richard</strong>
          </div>
          <div className="main-header__welcome-subtitle text-light">
            <i>"Lo que no se mide, no crece"</i>
          </div>
        </div>
    ...
    <div className="main__cards">
      <div className="card">
        <div className="card__header">
          <div className="card__header-title text-light">
            Comentarios <strong>recientes</strong>
          </div>
          ...
          <div className="card__row">
            ...
            <div className="card__detail">
              ...
              <div className="card__description">
                ¿Entonces no deberia utilizar css-grid?
              </div>
      ...
      <div className="card">
        <div className="card__header">
          <div className="card__header-title text-light">
            Recientes <strong>Publicaciones</strong>
          </div>
          <div className="settings">
            <div className="settings__block">
              <i className="fas fa-window-close"></i>
